      ...
      <div class="px-3 py-2 bg-dark text-white">
        <div class="container">
          ...
          >
            ...
            >
              <img
                src="https://laraveltuts.com/wp-content/uploads/2022/06/logo-dark.webp"
                style="height: 60px"
              />
            </router-link>
            <ul
...
<template>
    <div class="wrapper">
        ...
        <div class="sidebar">
            ...
            <ul>
                <li>
                    <router-link :to="`/admin/user`" class="active">
                ...
                <li>
                    <router-link :to="`/admin/mission-application`">
                        <span class="icon"><i class="fas fa-chart-line"></i></span>
                        <span class="item">Mission Application</span>
                    </router-link>
                </li>
                <li>
                    <router-link :to="`/admin/story`">
